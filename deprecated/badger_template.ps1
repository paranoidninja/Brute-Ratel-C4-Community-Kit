# This was the core powershell script (badger.ps1) which was active in BRc4 till release v1.0.4. The ps1 script executed the badger's shellcode (BADGER_SHELLCODE variable)
...
# Replace the 'BADGER_SHELLCODE' variable with any shellcode to execute via this script
